...
namespace LayerCompiler.Parsers
{
    ...
    static class PreprocessParser
    {
        ...
        /// 読み取り: #ifdef Aho
        /// </summary>
        public static readonly Parser<PreprocessDirective> Ifdef = 
                                                    ...
                                                    select new PreprocessDirective(DirectiveKind.Ifdef, name);

        /// <summary>
        /// 読み取り: #ifndef Aho
        /// </summary>
        public static readonly Parser<PreprocessDirective> Ifndef =
                                                    from sharp in Parse.String("#").TokenWithSkipCommentForPreprocessParser()
                                                    from keyword in Parse.String("ifndef").TokenWithSkipCommentForPreprocessParser()
                                                    from name in IdentifierForDefine.TokenWithSkipCommentForPreprocessParser()
                                                    from lineend in Parse.LineTerminator
                                                    select new PreprocessDirective(DirectiveKind.Ifndef, name);

        /// <summary>
        /// 読み取り: #if
        /// </summary>
        public static readonly Parser<PreprocessDirective> If =
                                                    from sharp in Parse.String("#").TokenWithSkipCommentForPreprocessParser()
                                                    ...
                                                    from lineend in Parse.LineTerminator
                                                    select new PreprocessDirective(DirectiveKind.If, expression);

        /// <summary>
        /// 読み取り: #elif
        /// </summary>
        public static readonly Parser<PreprocessDirective> Elif =
                                                    from sharp in Parse.String("#").TokenWithSkipCommentForPreprocessParser()
                                                    from keyword in Parse.String("elif").TokenWithSkipCommentForPreprocessParser()
                                                    from expression in ExpressionForDefine.TokenWithSkipCommentForPreprocessParser()
                                                    from lineend in Parse.LineTerminator
                                                    select new PreprocessDirective(DirectiveKind.Elif, expression);

        /// <summary>
        /// 読み取り: #else
        /// </summary>
        public static readonly Parser<PreprocessDirective> Else =
                                                    from sharp in Parse.String("#").TokenWithSkipCommentForPreprocessParser()
                                                    from keyword in Parse.String("else").TokenWithSkipCommentForPreprocessParser()
                                                    from lineend in Parse.LineTerminator
                                                    select new PreprocessDirective(DirectiveKind.Else);

        /// <summary>
        /// 読み取り: #endif
        /// </summary>
        public static readonly Parser<PreprocessDirective> Endif =
                                                    from sharp in Parse.String("#").TokenWithSkipCommentForPreprocessParser()
                                                    from keyword in Parse.String("endif").TokenWithSkipCommentForPreprocessParser()
                                                    from lineend in Parse.LineTerminator
                                                    select new PreprocessDirective(DirectiveKind.Endif);

        /// <summary>
        /// 読み取り: #define Aho
        /// </summary>
        public static readonly Parser<PreprocessDirective> Define =
                                                    from sharp in Parse.String("#").TokenWithSkipCommentForPreprocessParser()
                                                    ...
                                                    from lineend in Parse.LineTerminator
                                                    select new PreprocessDirective(DirectiveKind.Define, name, expression);

        /// <summary>
        /// 読み取り: #undef Aho
        /// </summary>
        public static readonly Parser<PreprocessDirective> UnDef =
                                                    from sharp in Parse.String("#").TokenWithSkipCommentForPreprocessParser()
                                                    from keyword in Parse.String("undef").TokenWithSkipCommentForPreprocessParser()
                                                    from name in IdentifierForDefine.TokenWithSkipCommentForPreprocessParser()
                                                    from lineend in Parse.LineTerminator
                                                    select new PreprocessDirective(DirectiveKind.Undef, name);
        ...
        /// </summary>
        public static readonly Parser<PreprocessDirective> Include =
                                                    from sharp in Parse.String("#").TokenWithSkipCommentForPreprocessParser()
                                                    ...
                                                    select new PreprocessDirective(DirectiveKind.Include, filename);
        ...
        /// 読み取り: #line
        /// </summary>
        public static readonly Parser<PreprocessDirective> Line =
                                                    from sharp in Parse.String("#").TokenWithSkipCommentForPreprocessParser()
                                                    ...
                                                    from lineend in Parse.LineTerminator
                                                    select new PreprocessDirective(DirectiveKind.Line, num, filename);

        /// <summary>
        /// 読み取り: #error
        /// </summary>
        public static readonly Parser<PreprocessDirective> Error =
                                                    from sharp in Parse.String("#").TokenWithSkipCommentForPreprocessParser()
                                                    ...
                                                    from lineend in Parse.LineTerminator
                                                    select new PreprocessDirective(DirectiveKind.Error, message);

        /// <summary>
        /// 読み取り: #pragma
        /// </summary>
        public static readonly Parser<PreprocessDirective> Pragma =
                                                    from sharp in Parse.String("#").TokenWithSkipCommentForPreprocessParser()
                                                    ...
                                                    from lineend in Parse.LineTerminator
                                                    select new PreprocessDirective(DirectiveKind.Pragma, param);

        /// <summary>
        /// 読み取り: 非標準
        /// </summary>
        public static readonly Parser<PreprocessDirective> NonStandard =
                                                    from sharp in Parse.String("#").TokenWithSkipCommentForPreprocessParser()
                                                    from keyword in IdentifierForDefine.TokenWithSkipCommentForPreprocessParser()
                                                    from param in ExpressionForDefine.XOr(Parse.Return("")).TokenWithSkipCommentForPreprocessParser()
                                                    from lineend in Parse.LineTerminator
                                                    select new PreprocessDirective(DirectiveKind.NonStandard, keyword, param);

        /// <summary>
        /// 読み取り: #
        /// </summary>
        public static readonly Parser<PreprocessDirective> None =
                                                    from sharp in Parse.String("#").TokenWithSkipCommentForPreprocessParser()
                                                    from lineend in Parse.LineTerminator
                                                    select new PreprocessDirective(DirectiveKind.None);
        ...
        /// 何らかのディレクティブ
        /// </summary>
        public static readonly Parser<PreprocessDirective> Directive =
                                                    Ifdef
                                                    .Or(Ifndef)
                                                    .Or(If)
                                                    .Or(Elif)
