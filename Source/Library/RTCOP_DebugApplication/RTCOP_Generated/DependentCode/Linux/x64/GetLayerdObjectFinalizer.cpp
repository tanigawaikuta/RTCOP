...
{
	volatile void* vfp = 0;
	asm volatile("movq $_ZN5RTCOP9Generated19JapaneseLayer_Hello27_RTCOP_FinalizePartialClassEv, %0" : "=r"(vfp) : : "memory");
...
{
	volatile void* vfp = 0;
	asm volatile("movq $_ZN5RTCOP9Generated18EnglishLayer_Hello27_RTCOP_FinalizePartialClassEv, %0" : "=r"(vfp) : : "memory");
