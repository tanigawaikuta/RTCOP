...
{
	volatile void* vfp = 0;
	asm volatile("movq $_ZN5RTCOP9Generated19JapaneseLayer_Hello21_FinalizePartialClassEv, %0" : "=r"(vfp) : : "memory");
...
{
	volatile void* vfp = 0;
	asm volatile("movq $_ZN5RTCOP9Generated18EnglishLayer_Hello21_FinalizePartialClassEv, %0" : "=r"(vfp) : : "memory");
