...
extrn		?_FinalizePartialClass@JapaneseLayer_Hello@Generated@RTCOP@@AEAAXXZ:PROC		; RTCOP::Generated::JapaneseLayer_Hello::_FinalizePartialClass
extrn		?_FinalizePartialClass@EnglishLayer_Hello@Generated@RTCOP@@AEAAXXZ:PROC			; RTCOP::Generated::EnglishLayer_Hello::_FinalizePartialClass

_TEXT	segment

		align		16
?GetLayerdObjectFinalizer@DependentCode@Generated@RTCOP@@YAPECXPEAVJapaneseLayer_Hello@23@@Z  proc
		mov			rax,	offset	?_FinalizePartialClass@JapaneseLayer_Hello@Generated@RTCOP@@AEAAXXZ
		ret
...
?GetLayerdObjectFinalizer@DependentCode@Generated@RTCOP@@YAPECXPEAVEnglishLayer_Hello@23@@Z  proc
		mov			rax,	offset	?_FinalizePartialClass@EnglishLayer_Hello@Generated@RTCOP@@AEAAXXZ
		ret
