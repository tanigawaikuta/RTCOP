...
volatile void** GetVirtualFunctionTable(JapaneseLayer* layer)
{
	// 仮想関数テーブルの取得
	volatile void** vft = 0;
	asm volatile("movl $__ZTVN5RTCOP9Generated19JapaneseLayer_HelloE+8, %0" : "=r"(vft) : : "memory");
...
volatile void** GetVirtualFunctionTable(EnglishLayer* layer)
{
	// 仮想関数テーブルの取得
	volatile void** vft = 0;
	asm volatile("movl $__ZTVN5RTCOP9Generated18EnglishLayer_HelloE+8, %0" : "=r"(vft) : : "memory");
