...
ROOTDIR			= ./../../..
LIBDIR			= -L$(ROOTDIR)/Test/TestSpace/Linux/Library/x64
LIBS			= -lRTCOP
INCLUDE			= -I$(ROOTDIR)/Include -I$(ROOTDIR)/Source/Library/RTCOP_DebugApplication
TARGET			= $(ROOTDIR)/Test/TestSpace/Linux/Library/x64/RTCOP_DebugApplication.out
...
OBJDIR			= $(ROOTDIR)/Object/Linux/Library/RTCOP_DebugApplication/x64
