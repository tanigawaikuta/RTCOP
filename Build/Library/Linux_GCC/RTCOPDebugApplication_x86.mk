CC				= g++
CFLAGS			= -MMD -MP -Wall -std=c++11 -D LINUX_X86
ARCHITECTURE	= -m32

ROOTDIR			= ./../../..
LIBDIR			= -L$(ROOTDIR)/Test/TestSpace/Linux/Library/x86
LIBS			= -lRTCOP
INCLUDE			= -I$(ROOTDIR)/Include -I$(ROOTDIR)/Source/Library/RTCOP_DebugApplication
TARGET			= $(ROOTDIR)/Test/TestSpace/Linux/Library/x86/RTCOP_DebugApplication.out
...
OBJDIR			= $(ROOTDIR)/Object/Linux/Library/RTCOP_DebugApplication/x86
