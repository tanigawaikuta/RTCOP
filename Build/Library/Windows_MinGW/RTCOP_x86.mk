...
TARGET			= $(ROOTDIR)/Test/TestSpace/Windows/Library/x86_mingw/libRTCOP.a
DIST_TARGET		= $(ROOTDIR)/Library/Windows/x86_mingw/libRTCOP.a
...
EXCLUDEDIRS		= -path $(SRCDIR)/DependentCode/Linux -prune -o \
					...
					-path $(SRCDIR)/DependentCode/Windows/x64_mingw -prune -o
SOURCES			= $(shell find $(SRCDIR) $(EXCLUDEDIRS) -type f -name *.cpp -print)
OBJDIR			= $(ROOTDIR)/Object/Windows/Library/RTCOP/x86_mingw
